...
namespace QLNS
{
    class Clsdatabase
    {
        ...
        string strconnect = @"Data Source=DESKTOP-CH7IJ1K\SqlExpress;Initial Catalog=QuanLyNhanSu;Integrated Security=True";
        ...
        public void loadtxtTimKiem(TextBox tb, string strselect, byte chiso)
        {
            ketnoi();
            sqlcom = new SqlCommand(strselect, sqlcon);
            sqldr = sqlcom.ExecuteReader();
